        ...
        <div className="grid gap-10 px-6 py-10 sm:px-8 lg:grid-cols-[1.1fr_0.7fr_0.8fr_0.9fr] lg:px-10 lg:py-12">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="editorial-title text-lg font-black tracking-tight text-white">
                  DGCC TECH
                </p>
            ...
            <p className="mt-6 max-w-md text-sm leading-7 text-white/58">
              A premium technology hub blending training, production services,
              repair support, and digital execution for modern clients.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a
                href="https://wa.me/2347082523166"
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#7c8dff]">
              Navigation
            </p>
